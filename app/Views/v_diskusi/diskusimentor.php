                                    ...
                                    <div class="card">
                                        ...
                                        <div class="container py-5">
                                            <div class="row justify-content-center">
                                                <div class="col-md">
                                                    <div class="card">
                                                        <!-- Petunjuk Penggunaan Chat Mentor -->
                                                        <div class="alert alert-info" role="alert">
                                                            <strong>Petunjuk Penggunaan:</strong> Ini adalah menu chat bagi mentor.
                                                            Anda dapat melihat dan membalas pesan-pesan dari peserta magang.
                                                        </div>
