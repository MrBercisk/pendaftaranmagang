        ...
        <div class="col-lg">
          <form id="formBiodataPeserta" method="post" role="form" class="php-email-form">
            ...
            <select class="form-control" name="nama_kampus">
                ...
                <option value="UBSI" <?php if ($cekTahapSatu['nama_kampus'] == 'UBSI') {echo "selected";}  ?> >UBSI</option>
                <option value="UGM" <?php if ($cekTahapSatu['nama_kampus'] == 'UGM') {echo "selected";}  ?> >UGM</option>
                <option value="UNY" <?php if ($cekTahapSatu['nama_kampus'] == 'UNY') {echo "selected";}  ?> >UNY</option>
                <option value="UMY" <?php if ($cekTahapSatu['nama_kampus'] == 'UMY') {echo "selected";}  ?> >UMY</option>
                <option value="UAD" <?php if ($cekTahapSatu['nama_kampus'] == 'UAD') {echo "selected";}  ?> >UAD</option>
                <option value="UPN" <?php if ($cekTahapSatu['nama_kampus'] == 'UPN') {echo "selected";}  ?> >UPN</option>
                <option value="STPMD" <?php if ($cekTahapSatu['nama_kampus'] == 'STPMD') {echo "selected";}  ?> >STPMD</option>
                <option value="AMIKOM" <?php if ($cekTahapSatu['nama_kampus'] == 'AMIKOM') {echo "selected";}  ?> >AMIKOM</option>
              </select>
            ...
            <div class="form-group">
              <textarea name="keahlian" class="form-control" id="keahlian" cols="30" rows="10" placeholder="Keahlian Anda" value="<?=$cekTahapSatu['keahlian']; ?>"></textarea>
              <small id="keahlian_error" class="form-text text-danger mb-3"></small>
            </div>
            <div class="form-group">
              <textarea name="tools" class="form-control" id="tools" cols="30" rows="10" placeholder="Tools Yang Anda Kuasai" value="<?=$cekTahapSatu['tools']; ?>"></textarea>
              <small id="keahlian_error" class="form-text text-danger mb-3"></small>
            </div>
            ...
            <div class="form-group">
              <select class="form-control" name="jenis_permohonan">
                ...
                <option value="Riset" <?php if ($cekTahapSatu['jenis_permohonan'] == 'Riset') {echo "selected";}  ?> >Riset</option>
                <option value="Kerja Praktek" <?php if ($cekTahapSatu['jenis_permohonan'] == 'Kerja Praktek') {echo "selected";}  ?> >Kerja Praktek</option>
              </select>
            ...
            <div class="form-group">
              <select class="form-control" name="status_permohonan">
                ...
                <option value="Individu" <?php if ($cekTahapSatu['status_permohonan'] == 'Individu') {echo "selected";}  ?> >Individu</option>
                <option value="Kelompok" <?php if ($cekTahapSatu['status_permohonan'] == 'Kelompok') {echo "selected";}  ?> >Kelompok</option>
              </select>
