        ...
        <section id="contact" class="contact">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <lottie-player src="https://assets9.lottiefiles.com/private_files/lf30_eivlwmgd.json" background="transparent" speed="1" style="width: 400px; height: 400px;" loop autoplay></lottie-player>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <form method="post" action="<?= base_url('AuthController/resetPassword/' . $token) ?>">
