...
class MentorPendaftarModel extends Model
{

    protected $table = "tbl_pendaftaran";
    protected $allowedFields = ['user_id', 'jadwal_id', 'bidang_id', 'mentor_id', 'kategori_id', 'nama_kategori', 'keterangan', 'nomor_pendaftaran', 'nama_peserta', 'nim', 'jenis_permohonan', 'nama_kampus', 'prodi', 'keahlian', 'nda', 'tools', 'judul', 'tbl_jadwal.tanggal_mulai', 'tbl_jadwal.tanggal_selesai', 'surat_permohonan', 'no_hp', 'alamat_peserta', 'status_permohonan', 'video_perkenalan', 'foto', 'berkas', 'tahap_satu', 'tahap_dua', 'tahap_tiga', 'tanggal_pendaftaran', 'status_pendaftaran', 'status_verifikasi'];
    protected $useTimestamps = true;
    protected $column_order = [null, 'foto', 'nomor_pendaftaran', 'nama_peserta', 'nama_kategori', 'tanggal_pendaftaran', 'status_verifikasi', 'keterangan', null];
    ...
    function __construct($request)
    {
        ...
        $this->dt = $this->db->table($this->table)
            ->select('tbl_pendaftaran.id, foto, nomor_pendaftaran, nama_peserta, tbl_kategori.nama_kategori, tanggal_pendaftaran, status_verifikasi, keterangan, tbl_user.nama')
